angular.module('arxivar.plugins').factory('esempioRotta', ['PluginRoute', function (PluginRoute) {
    // MANDATORY settings in order for the plugin to work.
    var requiredSettings = {
        id: '1d31452b-190e-41c1-b25b-909b9174e3d2', // Unique plugin identifier (type: string)
        name: 'esempioRotta', // Plugin name. Spaces special characters not allowed (type: string)
        icon: 'fas fa-bolt', 
        label: 'esempioRotta', // User Interface label (type: string)
        description: 'esempioRotta description', // Plugin description (type: string)
		...
		useTypescript: false // If this plugin use typescript compiler (type boolean. Default: false) 
